    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(max_length=255, unique=True, verbose_name='Correo Electronico')),
                ('name', models.CharField(blank=True, max_length=255, verbose_name='Nombres')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(db_index=True, max_length=255, verbose_name='Correo Electronico')),
                ('name', models.CharField(blank=True, max_length=255, verbose_name='Nombres')),
                ('last_name', models.CharField(blank=True, max_length=255, null=True, verbose_name='Apellidos')),
